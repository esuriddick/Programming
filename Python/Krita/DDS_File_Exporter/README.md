...
## Functionalities
When executed, this plugin will export the current selected open document into a _PNG_ image file in a temporary folder. Afterwards, this image file is converted to DSS and stored in the selected location. Finally, the _PNG_ image file is erased.
